...
func IsDay1Host(h *models.Host) bool {
	return swag.StringValue(h.Kind) == models.HostKindHost
}

func IsPoolClusterHost(h *models.Host) bool {
	return swag.StringValue(h.Kind) == models.HostKindPoolClusterHost
}
